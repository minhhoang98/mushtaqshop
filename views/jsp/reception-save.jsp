	...
	<div id="wrapper">
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<form:form action="${saveReception}" method="POST"
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							...
							</select> <br /> <label>Reservation Code:</label>
							<%-- <form:input class="form-control" path="reservationid" /> --%>
							<select class="form-control" name="reservationid">
							...
							</select> <br /> <label>Room Number</label> <select class="form-control"
								name="roomid">
								<c:if test="${not empty listRoom}">
							...
							</select> <br /> <label>Checkin Date:</label>
							<form:input class="form-control" path="checkindate"
								id="datepicker" placeholder="Check In Date" required="required"
								pattern="[a-z]\{20}" title="Please type Date" />
							<script>
								$(function() {
						...
						<div class="form-group col-md-6">
							...
							<br /> <label>Service:</label> <select class="form-control"
								name="serviceid">
							...
							</select> <br /> <label>Reception Status:</label>
							...
							<form:button id="editbutton" type="submit" class="btn btn-danger">
								<a href="<c:url value="/reception-list" />"><i
