			...
			<li class="nav-item dropdown"><a
				...
				<div class="dropdown-menu" aria-labelledby="pagesDropdown">
					...
					<a class="dropdown-item" 
						href="<c:url value="/employee-list"/>">List Employee</a> 
					<a class="dropdown-item"
						href="<c:url value="/employee-save"/>">Create Employee</a>
						
					<div class="dropdown-divider"></div>
					<h6 class="dropdown-header">Nha Cung Cap:</h6>
					<a class="dropdown-item" 
						href="<c:url value="/nhacungcap-list"/>">List Nhà Cung Cấp</a> 
					<a class="dropdown-item"
					...
					<div class="card-header">
						...
						<button type="submit" class="btn btn-primary float-right">
							<a style="text-decoration: none; color: white"
								...
								class="far fa-plus-square"></i> Employee Save</a>
						</button>
					</div>
					<div class="card-body">
