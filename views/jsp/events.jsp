		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 col-sm-6 col-12 post mb-5"
					...
					<div class="media media-custom d-block mb-4 h-100">
						<a href="#" class="mb-4 d-block"><img
							src="resources/images/img_1.jpg" alt="Image placeholder"
							class="img-fluid"></a>
				...
				<div class="col-lg-4 col-md-6 col-sm-6 col-12 post mb-5"
					...
					<div class="media media-custom d-block mb-4 h-100">
						<a href="#" class="mb-4 d-block"><img
							src="resources/images/img_2.jpg" alt="Image placeholder"
							class="img-fluid"></a>
						<div class="media-body">
							<span class="meta-post">February 26, 2018</span>
							<h2 class="mt-0 mb-3">
				...
				<div class="col-lg-4 col-md-6 col-sm-6 col-12 post mb-5"
					...
					<div class="media media-custom d-block mb-4 h-100">
						<a href="#" class="mb-4 d-block"><img
							src="resources/images/img_3.jpg" alt="Image placeholder"
							class="img-fluid"></a>
						<div class="media-body">
							<span class="meta-post">February 26, 2018</span>
							<h2 class="mt-0 mb-3">
				...
				<div class="col-lg-4 col-md-6 col-sm-6 col-12 post mb-5"
					...
					<div class="media media-custom d-block mb-4 h-100">
						<a href="#" class="mb-4 d-block"><img
							src="resources/images/img_4.jpg" alt="Image placeholder"
							class="img-fluid"></a>
						<div class="media-body">
							<span class="meta-post">February 26, 2018</span>
							<h2 class="mt-0 mb-3">
