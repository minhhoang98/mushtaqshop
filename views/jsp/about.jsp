						...
						<div class="back">
							...
							<div class="author d-flex">
								...
								<div class="name align-self-center">
									Will Peters <span class="position">President</span>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="flipper">
						...
						<div class="back">
							...
							<div class="author d-flex">
								...
								<div class="name align-self-center">
									Jane Williams <span class="position">Business Manager</span>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="flipper">
						...
						<div class="back">
							...
							<div class="author d-flex">
								...
								<div class="name align-self-center">
									Jeffrey Neddery <span class="position">Marketing
										Director</span>
								</div>
							</div>
						</div>
				...
				<div class="col-md-12">
					<div class="home-slider major-caousel owl-carousel mb-5"
						...
						<div class="slider-item">
							<a href="resources/images/slider-1.jpg" data-fancybox="images"
								data-caption="Caption for this image"><img
								src="resources/images/slider-1.jpg" alt="Image placeholder"
								class="img-fluid"></a>
						</div>
						<div class="slider-item">
							<a href="resources/images/slider-2.jpg" data-fancybox="images"
								data-caption="Caption for this image"><img
								src="resources/images/slider-2.jpg" alt="Image placeholder"
								class="img-fluid"></a>
						</div>
						<div class="slider-item">
							<a href="resources/images/slider-3.jpg" data-fancybox="images"
								data-caption="Caption for this image"><img
								src="resources/images/slider-3.jpg" alt="Image placeholder"
								class="img-fluid"></a>
						</div>
						<div class="slider-item">
							<a href="resources/images/slider-4.jpg" data-fancybox="images"
								data-caption="Caption for this image"><img
								src="resources/images/slider-4.jpg" alt="Image placeholder"
								class="img-fluid"></a>
						</div>
						<div class="slider-item">
							<a href="resources/images/slider-5.jpg" data-fancybox="images"
								data-caption="Caption for this image"><img
								src="resources/images/slider-5.jpg" alt="Image placeholder"
								class="img-fluid"></a>
						</div>
						<div class="slider-item">
							<a href="resources/images/slider-6.jpg" data-fancybox="images"
								data-caption="Caption for this image"><img
								src="resources/images/slider-6.jpg" alt="Image placeholder"
								class="img-fluid"></a>
						</div>
						<div class="slider-item">
							<a href="resources/images/slider-7.jpg" data-fancybox="images"
								data-caption="Caption for this image"><img
								src="resources/images/slider-7.jpg" alt="Image placeholder"
								class="img-fluid"></a>
						</div>
					</div>
					<!-- END slider -->
				...
				<div class="col-md-3 mb-5 pr-md-5 contact-info">
					...
					<p>
						<span class="d-block"><span
							...
							132 Ly Tu Trong Street, Quận 1, TP. Hồ Chí Minh, Việt
							Nam </span>
					</p>
					<p>
						<span class="d-block"><span
