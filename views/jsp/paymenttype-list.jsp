		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">List Payment Type</li>
				</ol>
				<!-- DataTables Example -->
				<div class="card mb-3">
					<div class="card-header">
						...
						<div style="float: right; color: white; text-decoration: none;">
							<button type="submit" class="btn btn-warning ">
								<a href="<c:url value="/paymenttype-save" /> "
									class="far fa-plus-square"
									style="text-decoration: none; list-style: none;"> New
									Payment Type</a>
							</button>
						</div>
					</div>
								...
								<c:if test="${not empty listpaymenttype}">
									<c:forEach var="paymenttype" items="${listpaymenttype}">
										<tr>
											...
											<td style="cursor: pointer;"><button
													class="btn btn-primary" type="submit">
													<a href="${urlUpdate}/${paymenttype.paymenttypeid}"><i
														class="fas fa-pen" style="color: black"></i></a>
												</button></td>
											<td><button type="submit" class="btn btn-danger">
													<a href="${urlDelete}/${paymenttype.paymenttypeid}"><i
