	...
	<div id="wrapper">
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<c:url value="/saveReceptionuser" var="saveReception" />
				<form:form action="${saveReception}" method="POST"
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							...
							</select> <br /> <label>Reservation ID:</label>
							<form:input class="form-control" path="reservationid" />
							<br /> <label>Room Number</label> <select class="form-control"
								name="roomid">
						...
						<div class="form-group col-md-6">
							...
							<form:button id="editbutton" type="submit" class="btn btn-danger">
								<a href="<c:url value="/reception-list-user" />"><i
