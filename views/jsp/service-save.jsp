		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<form:form action="${saveService}" modelAttribute="service"
					method="GET" enctype="multipart/form-data" name="myForm"
					onsubmit="return validateForm()">

					<label>Service Name</label>
					<form:input class="form-control form-control-lg" path="servicename"
						placeholder="Service Name" required="required" pattern="[a-z]\{4}"
					...
					<form:input class="form-control form-control-lg" path="servicedesc"
						placeholder="Service Desc " required="required"
						pattern="[a-z]\{4}"
						title="Do not enter number and enter at least 4 words" />
					<br />
					<label>Service Price</label>
					<form:input class="form-control form-control-lg"
						path="serviceprice" placeholder="Service Price "
					...
					<form:button id="editbutton" type="submit" class="btn btn-danger">
						<a style="color: white" href="<c:url value="/service-list" />"><i
